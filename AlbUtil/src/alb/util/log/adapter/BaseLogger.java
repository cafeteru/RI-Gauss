...
public abstract class BaseLogger implements Logger {
	...
	/**
	 * Returns info about the class and method of the logging class (the
	 * object's class which is calling this Log.xxx() method)
	 * 
	 * @return
	 */
	 ...
	 * 
	 * Finds it by exploring the call stack from top until it finds the first
	 * class that is outside the package of this logging framework.
	 * 
	 * @param stack
