package uo.ri.business.transactionScripts.facturasManagement;
...
public class FacturarReparacionesBusiness implements Action {
	
	public FacturarReparacionesBusiness(ListaIdsDto l) {
		this.l = l;
	}
	
	private ListaIdsDto l;
	...
	public void execute() throws BusinessException {
		try {
			...
			fact.numeroFactura = numeroFactura;
			fact.totalFactura = totalFactura;
			fact.iva = iva;
			fact.totalConIva = importe;
