...
public class Cliente {
	...
	public Cliente(String dni, String nombre, String apellidos, Address address,
	...
	public String toString() {
		return "Cliente [dni=" + dni + ", nombre=" + nombre + ", apellidos="
				+ apellidos + ", address=" + address + ", telefono=" + "]";
		// telefono + ", email=" + email + ;
	}

	public boolean elegibleBonoPorRecomendaciones() {
		if (comprobarAverias() == true
				&& comprobarAveriasDeRecomendados() == true) {
